...
- **Segment description tooltips** — hovering the segment header (e.g. `MSH`, `PID`) now shows the official HL7 segment description from the embedded dictionary as a CSS tooltip below the header (#45)
